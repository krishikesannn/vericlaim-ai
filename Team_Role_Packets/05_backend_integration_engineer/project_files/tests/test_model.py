...
class ModelTests(unittest.TestCase):
    ...
    def test_one_suspicious_view_is_not_diluted_by_other_images(self):
        ...
        suspicious["visual_fraud_probability"] = self.model.thresholds["review"] + 0.05
        ...
        self.assertGreaterEqual(claim["signals"]["visual_model"], self.model.thresholds["review"] * 100)
